...
const maxThreads = 30; // Số luồng tối đa chạy đồng thời
...
class GLaDOS {
    constructor() {
        ...
        this.durovPayloadUrl = 'https://raw.githubusercontent.com/mmo69trading/nodejs/refs/heads/main/durov.json';
    ...
    async main() {
        ...
        while (true) {
            ...
            await console.log(`[*] Major done. chờ ${28850} giây ...`);
